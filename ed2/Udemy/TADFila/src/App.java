...
/**
 * @class TadFilaJava
 * @author Marcio Porto Feitosa - 01/11/2022 - 09:09:22
 */
public class App {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (opc == 0) {
                ...
                System.out.println("-------------------------------------------------");
                System.out.println("Capacidade maxima -> " + fila.getTamMax());
                System.out.println("Tamanho (size) ----> " + fila.size());
                System.out.println("Primeiro elemento -> " + fila.peek());
                System.out.println("Ponteiro FRONT ------> " + fila.getFront());
                System.out.println("Ponteiro REAR ------> " + fila.getRear());
