...
public class App {
    ...
    public static void main(String[] args) {
        ...
        HashMap<Elemento> th = new HashMap<>(tam);
        ...
        while (true) {
            ...
            if (opc == 0) {
                ...
                boolean ret = th.add(e.getNumero(), e);
                if (ret) {
                    System.out.println("Inclusao bem sucedida");
                } else {
                    System.out.println("Tabela esta cheia!!");
                }
            } else if (opc == 2) {
                System.out.print("Informe o numero identificador do elemento -> ");
                Scanner scn2 = new Scanner(System.in);
                int nr = scn2.nextInt();
                Elemento i = th.query(nr);
                if (i != null) {
                    System.out.println("Elemento nao localizado.");
                } else {
                    System.out.println("Localizado " + i.getNome() + " | " + i.getNumero());
                }
            } else if (opc == 3) {
                System.out.print("Informe o numero identificador do elemento -> ");
                Scanner scn3 = new Scanner(System.in);
                int nr = scn3.nextInt();
                Elemento e = th.delete(nr);
                if (e == null){
