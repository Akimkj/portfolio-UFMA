...
public class Gerador {
    public static void main(String[] args) throws Exception {
        ...
        String[] sobrenomes = {
            ...
            "Cardoso","Barrio","Goncalves","Soares","Castro","Araujo","Carneiro","Monteiro","Moura","Teixeira", "Veigar", "Luiza", "Francisca", "Bastos", "Serra", "Miqueias"
        };

        Random rand = new Random();
        int quant = 1000000;
        Tabela_Hash<Boolean> usados = new Tabela_Hash<>(quant);
        BufferedWriter bw = new BufferedWriter(new FileWriter("dados_1M.txt"));
        int gerados = 0;

        while (gerados < quant) {
            int codigo = rand.nextInt(quant) + 1;
